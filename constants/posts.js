export const posts = [
  // educacional
  {
    ...
    }, 
    {
        ...
        texto: "Ensinar seu gato a sentar é possível com paciência e reforço positivo. Aqui vai um passo a passo simples:<br/><br/>1. Escolha um Petisco: Use um petisco que seu gato adore. Isso será fundamental para motivá-lo.<br/><br/>2. Segure o Petisco: Com o gato em pé, segure o petisco perto do nariz dele para chamar sua atenção.<br/><br/>3. Levante o Petisco: Devagar, mova o petisco em direção ao topo da cabeça do gato. Isso o incentivará a olhar para cima e, naturalmente, a sentar-se para alcançar o petisco.<br/><br/>4. Diga “Senta”: Quando ele começar a sentar, diga “Senta” de forma calma. Assim, ele começa a associar o comando com o movimento.<br/><br/>5. Recompense Imediatamente: Assim que ele sentar completamente, ofereça o petisco e elogie-o. A recompensa deve vir no mesmo instante, para reforçar o comportamento.<br/><br/>6. Repita e Pratique: Faça isso em sessões curtas e repetidas ao longo dos dias. Gatos aprendem com tempo e paciência, então mantenha as sessões leves e divertidas para ele.<br/><br/>7. Com o tempo, seu gato entenderá o comando e poderá até sentar sem a necessidade do petisco."
    },
    // eventos
    {
      ...
      caminho_imagem: "../img/protetores.jpg",
      alt_imagem: "",
